# SUA Sub Urban Anglers — Project Instructions
...
- Do not use em dashes (`—` or `&mdash;`). Use commas or parentheses instead.
- Do not use a hyphen as a separator (` - `). Use commas or parentheses instead.
